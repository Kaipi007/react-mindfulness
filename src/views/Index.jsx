...
export default function Index() {
  return (
    <>
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 px-4 order-2 md:order-1 md:-mt-4">
            ...
            <div className="pt-8 sm:pt-0 text-center">
              ...
              <div className="flex justify-center mt-10">
                <a
                  href="https://github.com/Kaipi007/react-mindfulness.git"
                  target="_blank"
      ...
      {/* NEW: Single container for all three feature sections with a continuous background */}
              ...
              <div className="sm:block  mt-10">
                <div class="flex flex-col items-center space-y-6">
                  <a
                    ...
                    target="_blank"
                    className="text-white font-bold px-6 py-4 rounded outline-none focus:outline-none bg-blueGray-700 hover:bg-blueGray-600 uppercase text-sm shadow hover:shadow-lg transition-all duration-150 w-72 text-center"
                    rel="noreferrer"
                  >
                    <i className="fab fa-github text-lg mr-1"></i>
                  ...
                  <a
                    href="https://github.com/Kaipi007/react-mindfulness.git"
                    target="_blank"
                    className="get-started text-white mt-4 font-bold px-6 py-4 rounded outline-none focus:outline-none bg-lightBlue-500 active:bg-lightBlue-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150 w-72 text-center"
                    rel="noreferrer"
                  >
